...
import {generateID, getType} from './utils.js';
...
export default class {
  ...
  constructor(name, root = '.db') {
    ...
    if(!existsSync(this.filepath)) {
      ...
      this.#records.records = this.#records.records.map((r, i) => {
        const schema = this.#records._schema[i];
